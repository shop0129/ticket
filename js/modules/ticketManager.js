...
function saveTicketManager() {
    ...
    for (var id in ticketData) {
        ...
        var pickupField = document.getElementById("pickupItem-".concat(id));
        ticket.pickupItem = pickupField ? pickupField.value : "none";
