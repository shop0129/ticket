...
ok(index.indexOf("V7.8.3.3 FIX7 Receipt + Auto Change") >= 0, "index exposes FIX7 version");
...
ok(
    index.indexOf("js/hardware/receipt-printer.js?v=7833fix7") <
        index.indexOf("js/hardware/cash-bridge.js?v=7833fix7"),
    "receipt bridge loads before the cash bridge"
);

var serviceWorker = read("service-worker.js");
ok(serviceWorker.indexOf("7833-fix7-receipt-auto-change-20260728-1") >= 0, "PWA cache is bumped");
...
(async function () {
    ...
    console.log("PASS FIX7 web regression: " + checks + " checks");
