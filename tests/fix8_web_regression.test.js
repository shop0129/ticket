...
ok(index.indexOf("V7.8.3.3 FIX8 Print Sync + Manager QR") >= 0, "index exposes FIX8 version");
...
ok(serviceWorker.indexOf("7833-fix8-print-sync-manager-qr-20260728-1") >= 0, "PWA cache is bumped");
