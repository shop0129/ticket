...
const checks = [
    ...
    ["FIX10 version badge exists", html.includes("V7.8.3.3 · FIX10 HEADER + CASH CANCEL")],
    ["stylesheet cache-buster changed", html.includes("css/style.css?v=7833fix10")],
    ["cash CSS cache-buster changed", html.includes("css/cash-bridge.css?v=7833fix10")],
    ["cash JS cache-buster changed", html.includes("js/hardware/cash-bridge.js?v=7833fix10")],
    ["Service Worker cache changed", sw.includes("7833-fix10-header-cash-cancel-20260728-1")],
    ...
    ["preflight can be safely canceled", cashBridge.includes("function cancelPreflight()")],
