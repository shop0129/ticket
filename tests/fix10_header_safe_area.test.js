...
const checks = [
    ...
    ["current FIX11 version badge exists", html.includes("V7.8.3.3 · FIX11 CASH DISPLAY + SMOOTH PRINT")],
    ...
    ["cash JS cache-buster changed", html.includes("js/hardware/cash-bridge.js?v=7833fix11")],
    ["Service Worker cache changed", sw.includes("7833-fix11-cash-display-smooth-print-20260728-1")],
