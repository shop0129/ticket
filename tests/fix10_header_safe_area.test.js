...
const checks = [
    ...
    ["current FIX12 version badge exists", html.includes("V7.8.3.3 · FIX12 CASH BUTTON + BACK RECOVERY")],
    ...
    ["cash JS cache-buster changed", html.includes("js/hardware/cash-bridge.js?v=7833fix12")],
    ["Service Worker cache changed", sw.includes("7833-fix12-cash-button-back-recovery-20260729-1")],
