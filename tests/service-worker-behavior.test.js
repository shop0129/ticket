...
global.caches = {
    ...
    keys: function () { return Promise.resolve(["monster-ticket-pwa-old", "monster-ticket-pwa-73f1-20260716-1", "monster-ticket-pwa-74-enterprise-745-mobile-safe-area-20260717-1", "unrelated"]); },
...
(async function () {
    ...
    ok(deleted.indexOf("monster-ticket-pwa-74-enterprise-745-mobile-safe-area-20260717-1") === -1, "activate 不可刪除 V7.4 cache");
