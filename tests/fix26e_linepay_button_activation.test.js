...
ok(index.indexOf("js/modules/payment.js?v=7833fix26e") >= 0, "付款核心快取版本應更新");
ok(index.indexOf("js/cloud/linepay-scanner.js?v=7833fix26e") >= 0, "LINE Pay 模組快取版本應更新");
ok(enterprise.indexOf('var BUILD = "FIX26E"') >= 0, "右下角版本應顯示 FIX26E");
ok(worker.indexOf("7833-fix26e-linepay-button-activation-20260731-1") >= 0, "Service Worker 快取應更新");
