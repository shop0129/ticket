...
ok(indexSource.indexOf("V7.8.3.3 · FIX12 CASH BUTTON + BACK RECOVERY") !== -1, "畫面版本標記應更新");
...
ok(workerSource.indexOf("7833-fix12-cash-button-back-recovery-20260729-1") !== -1, "PWA快取版本應更新");
