...
ok(indexSource.indexOf("V7.8.3.3 · FIX11 CASH DISPLAY + SMOOTH PRINT") !== -1, "畫面版本標記應更新");
...
ok(workerSource.indexOf("7833-fix11-cash-display-smooth-print-20260728-1") !== -1, "PWA快取版本應更新");
