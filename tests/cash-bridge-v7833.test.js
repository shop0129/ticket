...
ok(indexSource.indexOf("V7.8.3.3 · FIX9 PAYMENT PAGE + CART RESET") !== -1, "畫面版本標記應更新");
...
ok(workerSource.indexOf("7833-fix9-payment-page-cart-reset-20260728-1") !== -1, "PWA快取版本應更新");
