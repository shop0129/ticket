...
ok(indexSource.indexOf('content="V7.8.3.3 Sprint 8"') !== -1, "首頁應帶有可核對的Sprint 8版本");
...
ok(enterpriseSource.indexOf('VERSION = "7.8.3.3 S8"') !== -1, "唯一狀態標籤應顯示目前正式版本");
...
ok(workerSource.indexOf("7833-sprint8-production-golive") !== -1, "PWA快取版本應更新");
...
console.log("PASS V7.8.3.3 Sprint 8 cash integration: " + count + " assertions");
